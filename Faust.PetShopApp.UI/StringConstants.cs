namespace Faust.PetShopApp.UI
{
    ...
    {
        public static readonly string ShowWelcomeToAppText = "Welcome to Pet Shop Application!";
        public static readonly string ShowAllPetsMenuText = "Select 1 to show all pets";
        public static readonly string SearchPetsMenuText = "Select 2 to search for pets";
